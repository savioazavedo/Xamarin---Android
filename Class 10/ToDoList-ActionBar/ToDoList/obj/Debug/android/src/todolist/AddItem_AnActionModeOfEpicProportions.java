...
public class AddItem_AnActionModeOfEpicProportions
		...
		com.actionbarsherlock.view.ActionMode.Callback
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ToDoList.AddItem/AnActionModeOfEpicProportions, ToDoList, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AddItem_AnActionModeOfEpicProportions.class, __md_methods);
	}


	public AddItem_AnActionModeOfEpicProportions () throws java.lang.Throwable
	{
		super ();
		if (getClass () == AddItem_AnActionModeOfEpicProportions.class)
			mono.android.TypeManager.Activate ("ToDoList.AddItem/AnActionModeOfEpicProportions, ToDoList, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public AddItem_AnActionModeOfEpicProportions (todolist.AddItem p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == AddItem_AnActionModeOfEpicProportions.class)
			mono.android.TypeManager.Activate ("ToDoList.AddItem/AnActionModeOfEpicProportions, ToDoList, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "ToDoList.AddItem, ToDoList, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
